...
Java_com_vrv_sdptransform_SdpBridge_parse(
        JNIEnv *env,
        jclass cls,
        jstring sdp) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vrv_sdptransform_SdpBridge_parseParams(
        JNIEnv *env,
        jclass cls,
        jstring params) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vrv_sdptransform_SdpBridge_parsePayloads(
        JNIEnv *env,
        jclass cls,
        jstring payloads) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vrv_sdptransform_SdpBridge_parseImageAttributes(
        JNIEnv *env,
        jclass cls,
        jstring params) {
    std::string paramsStr = jstring2String(env, params);
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vrv_sdptransform_SdpBridge_parseSimulcastStreamList(
        JNIEnv *env,
        jclass cls,
        jstring streams) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vrv_sdptransform_SdpBridge_write(
        JNIEnv *env,
        jclass cls,
        jstring sdp) {
    std::string sdpStr = jstring2String(env, sdp);
